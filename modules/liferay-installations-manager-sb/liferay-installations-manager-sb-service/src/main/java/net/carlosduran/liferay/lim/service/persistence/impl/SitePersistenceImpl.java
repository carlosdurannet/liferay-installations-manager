...
import net.carlosduran.liferay.lim.model.impl.SiteImpl;
import net.carlosduran.liferay.lim.model.impl.SiteModelImpl;
...
public class SitePersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new SiteModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Site.class.getName()));
	...
	private static class SiteModelArgumentsResolver
		...
		private Object[] _getValue(
			SiteModelImpl siteModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = siteModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
