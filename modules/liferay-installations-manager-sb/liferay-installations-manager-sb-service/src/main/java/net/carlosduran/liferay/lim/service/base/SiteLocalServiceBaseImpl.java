...
import net.carlosduran.liferay.lim.service.SiteLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.carlosduran.liferay.lim.service.impl.SiteLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see net.carlosduran.liferay.lim.service.impl.SiteLocalServiceImpl
 * @generated
 */
public abstract class SiteLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SiteLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SiteLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>net.carlosduran.liferay.lim.service.SiteLocalServiceUtil</code>.
	 */
	...
	public Site addSite(Site site) {
		...
		return sitePersistence.update(site);
	}
	...
	public Site deleteSite(long siteId) throws PortalException {
		return sitePersistence.remove(siteId);
	}
	...
	public Site deleteSite(Site site) {
		return sitePersistence.remove(site);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Site.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return sitePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return sitePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Site fetchSite(long siteId) {
		return sitePersistence.fetchByPrimaryKey(siteId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(siteLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Site.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(siteLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Site.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sitePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return siteLocalService.deleteSite((Site)persistedModel);
	}

	public BasePersistence<Site> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sitePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SiteLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		siteLocalService = (SiteLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SiteLocalService.class.getName();
	}
