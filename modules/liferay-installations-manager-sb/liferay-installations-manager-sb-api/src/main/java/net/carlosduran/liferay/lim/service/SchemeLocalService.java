...
/**
 * Provides the local service interface for Scheme. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SchemeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SchemeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.carlosduran.liferay.lim.service.impl.SchemeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the scheme local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SchemeLocalServiceUtil} if injection and service tracking are not available.
	 */
