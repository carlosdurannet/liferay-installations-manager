...
public interface ModuleService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.carlosduran.liferay.lim.service.impl.ModuleServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the module remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ModuleServiceUtil} if injection and service tracking are not available.
	 */
