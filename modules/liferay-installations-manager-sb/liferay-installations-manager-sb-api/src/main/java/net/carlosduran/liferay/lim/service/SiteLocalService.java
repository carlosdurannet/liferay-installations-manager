...
/**
 * Provides the local service interface for Site. Methods of this
...
public interface SiteLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.carlosduran.liferay.lim.service.impl.SiteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the site local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SiteLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Site deleteSite(long siteId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Site fetchSite(long siteId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Site> getSites(int start, int end);
