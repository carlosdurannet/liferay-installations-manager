...
/**
 * Provides the local service interface for Installation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InstallationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface InstallationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>net.carlosduran.liferay.lim.service.impl.InstallationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the installation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link InstallationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Installation createInstallation(long installationId);
	...
	public Installation deleteInstallation(Installation installation);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Installation deleteInstallation(long installationId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Installation fetchInstallation(long installationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Installation> getInstallations(int start, int end);
